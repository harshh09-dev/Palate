...
const steps = [
  {
    ...
    subtitle: "This helps us personalize your recipes",
    options: ["Vegetarian", "Non-vegetarian", "Vegan", "Keto", "High Protein", "Low Carb"],
    multi: false,
  },
  {
    title: "What are your health goals?",
    subtitle: "We'll tailor meal plans to your goals",
    options: ["Lose Weight", "Maintain Weight", "Gain Muscle", "Healthy Eating"],
    multi: false,
  },
  {
    title: "Any food allergies?",
    subtitle: "Select all that apply",
    options: ["Peanuts", "Dairy", "Gluten", "Soy", "Eggs", "None"],
    multi: true,
  },
  {
    title: "Cooking preference?",
    subtitle: "What kind of meals do you enjoy?",
    options: ["Quick Meals", "Gourmet Cooking", "Budget Friendly", "Healthy Meals"],
    multi: false,
  },
  {
    title: "Meals per day",
    subtitle: "Which meals do you want us to plan?",
  ...
  const toggleOption = (option: string) => {
    setSelections((prev) => {
      ...
      if (step.multi) {
        ...
        return {
          ...prev,
          [currentStep]: filtered.includes(option)
